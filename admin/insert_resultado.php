					...
					<div class="panel-body">
                        ...
                        <fieldset>
                          ...
                          <div class="form-group">
						    ...
						    <div class="form-group">
                            <label class="col-sm-3 control-label" for="card-number">Nome da equipa que joga em casa</label>
                            <div class="col-sm-9">
...
$result = mysqli_query($link, $query) or die(mysql_error()."[".$query."]");
  ...
  ?>
						    ...
						    <div class="form-group">
                            <label class="col-sm-3 control-label" for="card-number">Nome da equipa que joga fora</label>
                            <div class="col-sm-9">
                             <select name="quantidades">
  <?php
