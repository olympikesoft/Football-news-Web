...
function devolve_tabela($link)
{
	$control = '';
	$controla = 0;
	$selectnews = "SELECT * FROM news where state='1' ORDER by views DESC";
	...
	while($rr = mysqli_fetch_array($resq))
	{
	   ...
	   if($count > 0 && $controla > 0)
	   {
		   ...
		   ?>
				...
				<td> <a href="news.php?id=<?php echo $id;?>">Link da Noticia</a></td>
				<td>
	   ...
	   $get_id = $_POST['estado'];
	    ...
	    $queryss = " UPDATE news SET state ='$get_state' WHERE id = '$get_id' ";
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="forms.php"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg> Gerir Noticias</a></li>
